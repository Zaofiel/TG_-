...
"""
Вот команды которые могут тебе помочь(но это не точно):

/new_project - используй для добавления нового проекта
/skills - добавляет скил к проекту
/projects - показывает созданные проекты
...
def skill_handler(message):
    """
    добавляет к записи проекта скилы
    """
    user_id = message.from_user.id
